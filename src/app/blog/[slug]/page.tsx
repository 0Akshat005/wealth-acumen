    ...
    <>
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-sm text-slate-400 hover:text-[#D9791A] transition-colors mb-8"
          >
          ...
          <div className="flex items-center gap-3 mb-4">
            <span className="text-sm text-[#D9791A] font-medium">{post.date}</span>
            ...
            <ul className="space-y-4">
              {post.keyPoints.map((point, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="mt-1.5 w-2 h-2 rounded-full bg-gradient-to-br from-[#E8A33D] to-[#C9670A] shrink-0" />
