          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl glass border-slate-200 flex items-center justify-center text-slate-500 hover:text-indigo-600 hover:border-indigo-600/30 transition-all shadow-sm"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600 font-medium">
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 text-indigo-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                </svg>
                <a href={`mailto:${brand.email}`} className="hover:text-indigo-600 transition-colors">
                  {brand.email}
                </a>
              </li>
              <li className="flex items-start gap-2">
                ...
                <a href={`tel:${brand.phone}`} className="hover:text-indigo-600 transition-colors">
                  {brand.phone}
                </a>
              </li>
              <li className="flex items-start gap-2">
